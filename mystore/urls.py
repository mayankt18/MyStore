...
from app.forms import MyPasswordResetForm, MySetPasswordForm, LoginForm
...
urlpatterns = [
    ...
    (template_name='app/pwdrst/password_reset.html', form_class=MyPasswordResetForm)
    , name="password_reset"),
    ...
    (template_name='app/pwdrst/password_reset_confirm.html', 
